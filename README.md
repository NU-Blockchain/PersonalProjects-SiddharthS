This project creates an NFT minting platform. It has a REACT frontend and utilizes the wagmi and rainbowkit packages to connect to a metamask wallet for transactions. 
